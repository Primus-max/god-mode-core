...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    artifacts: "Generated previews, exports, and releases.",
    bootstrap: "Capability install approvals and lifecycle results.",
    machine: "Linked-device machine control and kill switch state.",
