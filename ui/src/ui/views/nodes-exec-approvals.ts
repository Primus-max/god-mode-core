...
function securityOptionLabel(value: ExecSecurity): string {
  return t(`nodes.execApprovals.securityOptions.${value}`);
}
...
function askOptionLabel(value: ExecAsk): string {
  switch (value) {
    ...
    default:
      return t(`nodes.execApprovals.askOptions.${value}`);
  }
}
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        ...
        <button
          ...
          @click=${state.onSave}
        >
          ${state.saving ? t("nodes.saving") : t("nodes.save")}
        </button>
      </div>
        ...
        !ready
          ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.loading || !targetReady} @click=${state.onLoad}>
              ${state.loading ? t("nodes.loading") : t("nodes.execApprovals.load")}
            </button>
          </div>`
          : html`
  ...
  return html`
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.execApprovals.hostLabel")}</span>
            <select
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`
              <div class="muted">${t("nodes.execApprovals.noApprovalNodes")}</div>
            `
          : nothing
      }
    </div>
  ...
  return html`
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.execApprovals.modeLabel")}</span>
            <select
              ?disabled=${state.disabled}
              @change=${(event: Event) => {
                const target = event.target as HTMLSelectElement;
            ...
            >
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${t("nodes.execApprovals.useDefault")} (${defaults.security})
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
                (option) =>
                  html`<option
                    value=${option}
                    ?selected=${securityValue === option}
                  >
                    ${securityOptionLabel(option)}
                  </option>`,
              )}
            </select>
          </label>
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${t("nodes.execApprovals.useDefault")} (${defaults.ask})
                  </option>`
                  : nothing
              }
              ${ASK_OPTIONS.map(
                (option) =>
                  html`<option
                    value=${option}
                    ?selected=${askValue === option}
                  >
                    ${askOptionLabel(option)}
                  </option>`,
              )}
            </select>
          </label>
      ...
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.execApprovals.fallbackLabel")}</span>
            <select
              ?disabled=${state.disabled}
              @change=${(event: Event) => {
                const target = event.target as HTMLSelectElement;
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${t("nodes.execApprovals.useDefault")} (${defaults.askFallback})
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
                (option) =>
                  html`<option
                    value=${option}
                    ?selected=${askFallbackValue === option}
                  >
                    ${securityOptionLabel(option)}
                  </option>`,
              )}
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.execApprovals.autoAllowDefault")
                : autoIsDefault
        ...
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.execApprovals.enabledLabel")}</span>
            <input
              type="checkbox"
              ?disabled=${state.disabled}
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`
              <div class="muted">${t("nodes.execApprovals.emptyAllowlist")}</div>
            `
...
function renderAllowlistEntry(
  ...
  return html`
    <div class="list-item">
      ...
      <div class="list-meta">
        <label class="field">
          <span>${t("nodes.execApprovals.patternLabel")}</span>
          <input
            type="text"
            .value=${entry.pattern ?? ""}
            ?disabled=${state.disabled}
