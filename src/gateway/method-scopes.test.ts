...
describe("method scope resolution", () => {
  it.each([
    ...
    ["platform.runtime.actions.list", ["operator.read"]],
    ["platform.runtime.actions.get", ["operator.read"]],
    ["platform.runtime.checkpoints.list", ["operator.read"]],
    ["platform.runtime.checkpoints.get", ["operator.read"]],
    ["platform.runtime.closures.list", ["operator.read"]],
    ["platform.runtime.closures.get", ["operator.read"]],
    ...
    ["platform.runtime.checkpoints.dispatch", ["operator.approvals"]],
...
describe("operator scope authorization", () => {
  it.each([
    ...
    ["platform.runtime.actions.list", ["operator.read"], { allowed: true }],
    ["platform.runtime.checkpoints.list", ["operator.read"], { allowed: true }],
    ["platform.runtime.closures.list", ["operator.read"], { allowed: true }],
    ["platform.bootstrap.resolve", ["operator.approvals"], { allowed: true }],
    ["platform.runtime.checkpoints.dispatch", ["operator.approvals"], { allowed: true }],
