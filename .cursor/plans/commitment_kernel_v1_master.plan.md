...
| ------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `no-raw-user-text-import`             | Hard invariants #5, #6 | Node check-script `scripts/check-no-raw-user-text-import.mjs` + whitelist `intent-contractor.ts` (конвенция репо: `lint:routing:no-prompt-parsing` style) |
| `no-decision-imports-from-commitment` | Hard invariant #8      | Node check-script `scripts/check-no-decision-imports-from-commitment.mjs`                                                                                 |
