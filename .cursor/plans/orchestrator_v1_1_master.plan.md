...
Активный следующий фокус P1: **P1.2 ensureCredentials**, затем **P1.1
agent_persona** (см. `orchestrator_v1_1_p1.plan.md`).
...
- 2026-04-22 — **P1.5 закрыт полностью (A+B+C)**. Stage A: `WorkspaceProbe` /
  ...
  Активный следующий фокус P1: **P1.2 ensureCredentials**.
